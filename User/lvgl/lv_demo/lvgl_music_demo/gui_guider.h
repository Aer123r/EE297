...
#include "lvgl.h"
#include "lv_demo/lvgl_music_demo/guider_fonts/guider_fonts.h"
...
LV_IMG_DECLARE(_cover_1_175x175);
LV_IMG_DECLARE(_btn_rnd_25x25);
LV_IMG_DECLARE(_cover_2_175x175);
LV_IMG_DECLARE(_wave_bottom_800x51);
LV_IMG_DECLARE(_btn_list_pause_70x70);
LV_IMG_DECLARE(_icn_chat_25x25);
LV_IMG_DECLARE(_cover_3_175x175);
LV_IMG_DECLARE(_btn_prev_61x61);
LV_IMG_DECLARE(_icn_heart_25x25);
LV_IMG_DECLARE(_btn_list_play_70x70);
LV_IMG_DECLARE(_icn_download_25x25);
LV_IMG_DECLARE(_btn_play_alpha_80x84);
LV_IMG_DECLARE(_btn_next_61x61);
LV_IMG_DECLARE(_icn_chart_25x25);
LV_IMG_DECLARE(_wave_top_800x51);
LV_IMG_DECLARE(_btn_pause_alpha_80x84);
LV_IMG_DECLARE(_icn_slider_25x25);
LV_IMG_DECLARE(_btn_loop_25x25);
